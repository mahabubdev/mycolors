    ...
    return (
        <div className="auth-page">
            ...
            <form className="form" onSubmit={formSubmit}>
                <input name="username" type="text" placeholder="Username" onChange={inputHandleChange}  /> <br />
                <input name="password" type="password" placeholder="Password" onChange={inputHandleChange}  /> <br />
